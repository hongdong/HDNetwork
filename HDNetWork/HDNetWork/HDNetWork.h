...
extern NSInteger const HDResponseCancelError;


typedef void (^HDRequestManagerConfigurationHandler)(HDRequestManagerConfiguration *configuration);

typedef void (^HDRequestManagerCompletionHandler)(NSError *error, id result, BOOL isFromCache, AFHTTPRequestOperation *operation);

typedef void (^HDRequestManagerParametersHandler)(NSMutableDictionary *requestParameters, NSMutableDictionary *builtinParameters);

@interface HDNetWork : NSObject
HDSingletonH(HDNetWork)
 ...
 */
@property(nonatomic) HDRequestManagerConfiguration *configuration;
 ...
 */
@property (nonatomic, copy) HDRequestManagerParametersHandler parametersHandler;
